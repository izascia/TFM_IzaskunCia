...
from utils import assign_cluster
...
class Loader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        sample_image = cv2.imread(os.path.join(self.data_path, curr_key.replace('_f.json', '.png')))
        ...
        return {
            ...
            "label": torch.from_numpy(label_final).type(torch.FloatTensor),
...
def load_data(data_path,json_path):
    ...
    dataset = Loader(data_path, json_path)
    return dataset
