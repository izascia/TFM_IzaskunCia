...
if __name__ == '__main__':
    ...
    lr = 0.0001 
    metric = 'WMSE'
    exp_name = f'{metric}_LR_{lr}_LAST'
    createDirectory(PROJECT_DIRECTORY.joinpath('DATA_AND_RESULTS','MODELS', 'BASE_MODEL', exp_name))
    ...
    path_to_save : Path = PROJECT_DIRECTORY.joinpath('DATA_AND_RESULTS','MODELS', 'BASE_MODEL', exp_name)
    print(path_to_save)
